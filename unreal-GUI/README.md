...
2. **重命名项目**: 使用 [renom](https://github.com/UnrealisticDev/Renom) 进行重命名操作，需要管理员权限，请确保`renom.exe`开启`以管理员身份启动`否则会弹出拒绝访问`os error 5`。
...
- [Concentus.Oggfile](https://github.com/lostromb/concentus.oggfile)&[NAudio.Wasapi](https://github.com/naudio/NAudio)
## 相关文档
